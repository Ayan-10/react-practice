...
const MODULES = [
  { path: "m01", title: "m01 · StayFinder — filter chips (amenities/country/rating, AND logic)", topic: "derived data, multi-select toggle", el: <M01 /> },
  { path: "m02", title: "m02 · TravelWallet — currency converter (live convert)", topic: "async, dropdowns, state", el: <M02 /> },
  { path: "m03", title: "m03 · GroceryCart — cart management (qty, total)", topic: "list state, derived totals", el: <M03 /> },
  { path: "m04", title: "m04 · JobApply — schema-driven form", topic: "dynamic controlled form, validation", el: <M04 /> },
  { path: "m05", title: "m05 · MovieRatings — star rating", topic: "hover/click, controlled value", el: <M05 /> },
  { path: "m06", title: "m06 · DailyPlanner — todo list (add/toggle/delete/filter)", topic: "CRUD + filter tabs", el: <M06 /> },
  { path: "m07", title: "m07 · BookStore — sort control", topic: "sorting derived list", el: <M07 /> },
  { path: "m08", title: "m08 · ContactsApp — client-side search filter", topic: "text filter", el: <M08 /> },
  { path: "m09", title: "m09 · CheckoutFlow — multi-step wizard", topic: "step state, per-step validation", el: <M09 /> },
  { path: "m10", title: "m10 · ReaderApp — theme toggle via Context", topic: "context, theming", el: <M10 /> },
];
